...
namespace GeneratedWrappers.SOLUTIONNAME
{
    class IN2025PL_PXGenericInqGrphExtension : IN2025PL_PXGenericInqGrph
    {
        ...
        public c_results_grid results_grid => Results_grid;
        public c_results_lv0 results_lv0 => Results_lv0;
        public c_addnewkeys_grdkeys addNewKeys_grdKeys => AddNewKeys_grdKeys;
        public c_addnewkeys_lv0 addNewKeys_lv0 => AddNewKeys_lv0;
        public c_fields_grdfields fields_grdFields => Fields_grdFields;
        public c_fields_lv0 fields_lv0 => Fields_lv0;
        public c_filterpreview_formpreview filterPreview_FormPreview => FilterPreview_FormPreview;
        public c_pivot_grid pivot_Grid => Pivot_Grid;
    }
}
