...
namespace ISVTestSDK.Extensions
{
    ...
    public class SO302000_SOShipmentEntry : Wrapper
    {
        ...
        public class c_soshipmentlinesplittingextension_lotseroptions_optform : Container
        {
            ...
            public c_soshipmentlinesplittingextension_lotseroptions_optform(string locator, string name) : 
                    base(locator, name)
            {
                ...
                DataMemberName = "SOShipmentLineSplittingExtension_LotSerOptions";
                Buttons = new PxButtonCollection();
            }
