...
namespace GeneratedWrappers.SOLUTIONNAME
{
    ...
    public class SO301000_SOOrderEntry : Wrapper
    {
        ...
        protected c_currentdocument_mapadoc CurrentDocument_Mapadoc { get; } = new c_currentdocument_mapadoc("ctl00_phG_tab_t6_Mapadoc", "CurrentDocument_Mapadoc");
        ...
        protected c_rutrots_rutrotform Rutrots_RUTROTForm { get; } = new c_rutrots_rutrotform("ctl00_phG_tab_t18_RUTROTForm", "Rutrots_RUTROTForm");
        ...
        protected c_ispstransactions_cstpxgrid24 ISPSTransactions_CstPXGrid24 { get; } = new c_ispstransactions_cstpxgrid24("ctl00_phG_tab_t7_CstPXGrid24", "ISPSTransactions_CstPXGrid24");
        protected c_ispstransactions_lv0 ISPSTransactions_lv0 { get; } = new c_ispstransactions_lv0("ctl00_phG_tab_t7_CstPXGrid24_lv0", "ISPSTransactions_lv0");
        ...
        protected c_billing_address_forma Billing_Address_formA { get; } = new c_billing_address_forma("ctl00_phG_tab_t16_formA", "Billing_Address_formA");
        protected c_shipping_address_formb Shipping_Address_formB { get; } = new c_shipping_address_formb("ctl00_phG_tab_t16_formB", "Shipping_Address_formB");
        protected c_billing_contact_formc Billing_Contact_formC { get; } = new c_billing_contact_formc("ctl00_phG_tab_t16_formC", "Billing_Contact_formC");
        protected c_shipping_contact_formd Shipping_Contact_formD { get; } = new c_shipping_contact_formd("ctl00_phG_tab_t16_formD", "Shipping_Contact_formD");
        protected c_approval_lv0 Approval_lv0 { get; } = new c_approval_lv0("ctl00_phG_tab_t17_gridApproval_lv0", "Approval_lv0");
        protected c_approval_gridapproval Approval_gridApproval { get; } = new c_approval_gridapproval("ctl00_phG_tab_t17_gridApproval", "Approval_gridApproval");
        ...
        protected c_rrdistribution_lv0 RRDistribution_lv0 { get; } = new c_rrdistribution_lv0("ctl00_phG_tab_t18_RUTROTForm_gridDistribution_lv0", "RRDistribution_lv0");
        protected c_rrdistribution_griddistribution RRDistribution_gridDistribution { get; } = new c_rrdistribution_griddistribution("ctl00_phG_tab_t18_RUTROTForm_gridDistribution", "RRDistribution_gridDistribution");
        ...
        protected c_cwaccommissionsplits_cwacgridsalespersons CWACCommissionSplits_CWACgridSalespersons { get; } = new c_cwaccommissionsplits_cwacgridsalespersons("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons", "CWACCommissionSplits_CWACgridSalespersons");
        protected c_cwaccommissionsplits_lv0 CWACCommissionSplits_lv0 { get; } = new c_cwaccommissionsplits_lv0("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0", "CWACCommissionSplits_lv0");
        protected c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid CWACSalesOrderCommissionSplits_DefaultCommissionSplitGrid { get; } = new c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid", "CWACSalesOrderCommissionSplits_DefaultCommissionSplitGrid");
        protected c_cwacsalesordercommissionsplits_lv0 CWACSalesOrderCommissionSplits_lv0 { get; } = new c_cwacsalesordercommissionsplits_lv0("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0", "CWACSalesOrderCommissionSplits_lv0");
        protected c_ispseditlinenumberview_ispseditlinenumberform ISPSEditLineNumberView_ISPSEditLineNumberForm { get; } = new c_ispseditlinenumberview_ispseditlinenumberform("ctl00_phG_ISPSEditLineNumberPanel_ISPSEditLineNumberForm", "ISPSEditLineNumberView_ISPSEditLineNumberForm");
        protected c_ispscopyedidataview_ispscopyedidataform ISPSCopyEdiDataView_ISPSCopyEdiDataForm { get; } = new c_ispscopyedidataview_ispscopyedidataform("ctl00_phG_ISPSCopyEdiDataPanel_ISPSCopyEdiDataForm", "ISPSCopyEdiDataView_ISPSCopyEdiDataForm");
        ...
        public virtual void CWACDefaultCommissionSplit()
        {
            ToolBar.CWACDefaultCommissionSplit.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton CWACDefaultCommissionSplit { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                CWACDefaultCommissionSplit = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_cWACDefaultCommissionSplit,#ctl00_phDS_ds_ToolBar_cWAC" +
                        "DefaultCommissionSplit_item", "Default Commission", locator, MenuOpener);
        ...
        public class c_document_form : Container
        {
			...
			public CheckBox UsrCWACInsertDefaultSplits { get; }
			public Label UsrCWACInsertDefaultSplitsLabel { get; }
                    ...
                    base(locator, name)
            {
                ...
                UsrCWACInsertDefaultSplits = new CheckBox("ctl00_phF_form_t0_CstPXCheckBox2", "UsrCWACInsertDefaultSplits", locator, null);
                UsrCWACInsertDefaultSplitsLabel = new Label(UsrCWACInsertDefaultSplits);
                UsrCWACInsertDefaultSplits.DataField = "UsrCWACInsertDefaultSplits";
        ...
        public class c_transactions_lv0 : Container
        {
			...
			public CheckBox UsrCWACIsCommissionable { get; }
			public Label UsrCWACIsCommissionableLabel { get; }
			public Selector Es { get; }
			public Label EsLabel { get; }
			public DropDown Ec { get; }
			public Selector OrderType { get; }
                    ...
                    base(locator, name)
            {
                ...
                UsrCWACIsCommissionable = new CheckBox("ctl00_phG_tab_t0_grid_lv0_CWACchkIsCommissionable", "UsrCWACIsCommissionable", locator, null);
                UsrCWACIsCommissionableLabel = new Label(UsrCWACIsCommissionable);
                UsrCWACIsCommissionable.DataField = "UsrCWACIsCommissionable";
        ...
        public class c_transactions_grid : Grid<c_transactions_grid.c_grid_row, c_transactions_grid.c_grid_header>
        {
            ...
            public virtual void CWACCommissionSplit()
            {
                ToolBar.CWACCommissionSplit.Click();
            }
			...
			public ToolBarButtonGrid CWACCommissionSplit { get; }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    ...
                    CWACCommissionSplit = new ToolBarButtonGrid("css=#ctl00_phG_tab_t0_grid_at_tlb div[data-cmd=\'CWACCommissionSplit\']", "Commission Split", locator, null);
			...
			public PXNumberEdit OpenQty { get; }
			public PXNumberEdit CuryUnitCost { get; }
			public PXNumberEdit UsrCWACActualCost { get; }
			public PXNumberEdit CuryUnitPrice { get; }
			public CheckBox ManualPrice { get; }
			public PXNumberEdit CuryExtPrice { get; }
			public PXNumberEdit DiscPct { get; }
			...
			public PXNumberEdit UsrCWACSplitPercentageTotal { get; }
			public CheckBox ManualDisc { get; }
			public CheckBox AutomaticDiscountsDisabled { get; }
			...
			public Selector AMConfigKeyID { get; }
			public CheckBox UsrCWACAreCommissionsProcessed { get; }
			public CheckBox UsrCWACIsCommissionable { get; }
                        ...
                        base(grid)
                {
                    ...
                    CuryUnitCost.DataField = "CuryUnitCost";
                    UsrCWACActualCost = new PXNumberEdit("ctl00_phG_tab_t0_grid_en", "Actual Cost", grid.Locator, "UsrCWACActualCost");
                    UsrCWACActualCost.DataField = "UsrCWACActualCost";
                    ...
                    UsrCWACSplitPercentageTotal = new PXNumberEdit("ctl00_phG_tab_t0_grid_en", "Total Commission Split %", grid.Locator, "UsrCWACSplitPercentageTotal");
                    UsrCWACSplitPercentageTotal.DataField = "UsrCWACSplitPercentageTotal";
                    ...
                    AMConfigKeyID.DataField = "AMConfigKeyID";
                    UsrCWACAreCommissionsProcessed = new CheckBox("ctl00_phG_tab_t0_grid", "Commissions Processed", grid.Locator, "UsrCWACAreCommissionsProcessed");
                    UsrCWACAreCommissionsProcessed.DataField = "UsrCWACAreCommissionsProcessed";
                    UsrCWACIsCommissionable = new CheckBox("_ctl00_phG_tab_t0_grid_lv0_CWACchkIsCommissionable", "UsrCWACIsCommissionable", grid.Locator, "UsrCWACIsCommissionable");
                    UsrCWACIsCommissionable.DataField = "UsrCWACIsCommissionable";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXNumberEditColumnFilter UsrCWACActualCost { get; }
				...
				public PXNumberEditColumnFilter UsrCWACSplitPercentageTotal { get; }
				...
				public CheckBoxColumnFilter UsrCWACAreCommissionsProcessed { get; }
				public CheckBoxColumnFilter UsrCWACIsCommissionable { get; }
                        ...
                        base(grid)
                {
                    ...
                    UsrCWACActualCost = new PXNumberEditColumnFilter(grid.Row.UsrCWACActualCost);
                    ...
                    UsrCWACSplitPercentageTotal = new PXNumberEditColumnFilter(grid.Row.UsrCWACSplitPercentageTotal);
                    ...
                    UsrCWACAreCommissionsProcessed = new CheckBoxColumnFilter(grid.Row.UsrCWACAreCommissionsProcessed);
                    UsrCWACIsCommissionable = new CheckBoxColumnFilter(grid.Row.UsrCWACIsCommissionable);
                }
            }
        }
        ...
        public class c_cwaccommissionsplits_cwacgridsalespersons : Grid<c_cwaccommissionsplits_cwacgridsalespersons.c_grid_row, c_cwaccommissionsplits_cwacgridsalespersons.c_grid_header>
        {
            ...
            public c_cwaccommissionsplits_cwacgridsalespersons(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons");
                DataMemberName = "CWACCommissionSplits";
                Buttons = new PxButtonCollection();
                FilterForm = new c_grid_filter("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_fe_gf", "FilterForm");
                FilesUploadDialog = new SmartPanel_AttachFile(locator);
                NotePanel = new Note(locator);
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_at_tlb div[data-cmd=\'Re" +
                            "fresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_at_tlb div[data-cmd=\'Ad" +
                            "dNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_at_tlb div[data-cmd=\'De" +
                            "lete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_at_tlb div[data-cmd=\'Ad" +
                            "justColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_at_tlb div[data-cmd=\'Ex" +
                            "portExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_at_tlb div[data-cmd=\'hi" +
                            "\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_ab_tlb div[data-cmd=\'Pa" +
                            "geFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_ab_tlb div[data-cmd=\'Pa" +
                            "gePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_ab_tlb div[data-cmd=\'Pa" +
                            "geNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_ab_tlb div[data-cmd=\'Pa" +
                            "geLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_ab_tlb div[data-cmd=\'hi" +
                            "\']", "Hi", locator, null);
                }
            }
			...
			public Button Cancel { get; }
                ...
                public PxButtonCollection()
                {
                    Accept = new Button("ctl00_phG_PanelCommissionSplits_PXButtonOk", "Accept", "ctl00_phG_PanelCommissionSplits_CWACgridSalespersons");
                    Cancel = new Button("ctl00_phG_PanelCommissionSplits_PXButtonCancel", "Cancel", "ctl00_phG_PanelCommissionSplits_CWACgridSalespersons");
                }
            }
			...
			public DropDown SalesPerson__UsrCWACRole { get; }
			public PXNumberEdit SplitPercentage { get; }
			public PXNumberEdit DollarAmt { get; }
			public CheckBox IsDefault { get; }
			public CheckBox Processed { get; }
			public PXNumberEdit CommissionSplitId { get; }
                
                public c_grid_row(c_cwaccommissionsplits_cwacgridsalespersons grid) : 
                        base(grid)
                {
                    Files = new FileColumnButton(null, "Files", grid.Locator, "Files");
                    Notes = new NoteColumnButton(null, "Notes", grid.Locator, "Notes");
                    SalesPersonId = new Selector("_ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0_CWACedSalesPersonId", "Salesperson ID", grid.Locator, "SalesPersonId");
                    SalesPersonId.DataField = "SalesPersonId";
                    SalesPersonId_SalesPerson_descr = new PXTextEdit("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_ei", "Name", grid.Locator, "SalesPersonId_SalesPerson_descr");
                    SalesPersonId_SalesPerson_descr.DataField = "SalesPersonId_SalesPerson_descr";
                    SalesPerson__UsrCWACRole = new DropDown("_ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0_ec", "Role", grid.Locator, "SalesPerson__UsrCWACRole");
                    SalesPerson__UsrCWACRole.DataField = "SalesPerson__UsrCWACRole";
                    SalesPerson__UsrCWACRole.Items.Add("S", "Salesperson");
                    SalesPerson__UsrCWACRole.Items.Add("M", "Manager");
                    SplitPercentage = new PXNumberEdit("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_en", "Commission Split %", grid.Locator, "SplitPercentage");
                    SplitPercentage.DataField = "SplitPercentage";
                    DollarAmt = new PXNumberEdit("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_en", "Dollar Amount", grid.Locator, "DollarAmt");
                    DollarAmt.DataField = "DollarAmt";
                    IsDefault = new CheckBox("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_ef", "Primary", grid.Locator, "IsDefault");
                    IsDefault.DataField = "IsDefault";
                    Processed = new CheckBox("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons", "Processed", grid.Locator, "Processed");
                    Processed.DataField = "Processed";
                    CommissionSplitId = new PXNumberEdit("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_en", "CommissionSplitId", grid.Locator, "CommissionSplitId");
                    CommissionSplitId.DataField = "CommissionSplitId";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
				...
				public DropDownColumnFilter SalesPerson__UsrCWACRole { get; }
				public PXNumberEditColumnFilter SplitPercentage { get; }
				public PXNumberEditColumnFilter DollarAmt { get; }
				public CheckBoxColumnFilter IsDefault { get; }
				public CheckBoxColumnFilter Processed { get; }
				public PXNumberEditColumnFilter CommissionSplitId { get; }
                
                public c_grid_header(c_cwaccommissionsplits_cwacgridsalespersons grid) : 
                        base(grid)
                {
                    Files = new GridColumnHeader(grid.Row.Files);
                    Notes = new GridColumnHeader(grid.Row.Notes);
                    ...
                    SalesPerson__UsrCWACRole = new DropDownColumnFilter(grid.Row.SalesPerson__UsrCWACRole);
                    SplitPercentage = new PXNumberEditColumnFilter(grid.Row.SplitPercentage);
                    DollarAmt = new PXNumberEditColumnFilter(grid.Row.DollarAmt);
                    IsDefault = new CheckBoxColumnFilter(grid.Row.IsDefault);
                    Processed = new CheckBoxColumnFilter(grid.Row.Processed);
                    CommissionSplitId = new PXNumberEditColumnFilter(grid.Row.CommissionSplitId);
                }
            }
        }
        
        public class c_cwaccommissionsplits_lv0 : Container
        {
            ...
            public c_cwaccommissionsplits_lv0(string locator, string name) : 
                    base(locator, name)
            {
                SalesPersonId = new Selector("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0_CWACedSalesPersonId", "Salesperson ID", locator, null);
                SalesPersonIdLabel = new Label(SalesPersonId);
                SalesPersonId.DataField = "SalesPersonId";
                Es = new Selector("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ec = new DropDown("ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0_ec", "Ec", locator, null);
                DataMemberName = "CWACCommissionSplits";
                Buttons = new PxButtonCollection();
            }
			...
			public Button Cancel { get; }
                ...
                public PxButtonCollection()
                {
                    SalesPersonIdEdit = new Button("css=div[id=\'ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0_CWACedSalesP" +
                            "ersonId\'] div[class=\'editBtnCont\'] > div > div", "SalesPersonIdEdit", "ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0");
                    SalesPersonIdEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    Accept = new Button("ctl00_phG_PanelCommissionSplits_PXButtonOk", "Accept", "ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0");
                    Cancel = new Button("ctl00_phG_PanelCommissionSplits_PXButtonCancel", "Cancel", "ctl00_phG_PanelCommissionSplits_CWACgridSalespersons_lv0");
                }
            }
        }
        
        public class c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid : Grid<c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid.c_grid_row, c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid.c_grid_header>
        {
            ...
            public c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid");
                DataMemberName = "CWACSalesOrderCommissionSplits";
                Buttons = new PxButtonCollection();
                FilterForm = new c_grid_filter("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_fe_gf", "FilterForm");
                FilesUploadDialog = new SmartPanel_AttachFile(locator);
                NotePanel = new Note(locator);
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_at_tlb div[dat" +
                            "a-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_at_tlb div[dat" +
                            "a-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_at_tlb div[dat" +
                            "a-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_at_tlb div[dat" +
                            "a-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_at_tlb div[dat" +
                            "a-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_at_tlb div[dat" +
                            "a-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_ab_tlb div[dat" +
                            "a-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_ab_tlb div[dat" +
                            "a-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_ab_tlb div[dat" +
                            "a-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_ab_tlb div[dat" +
                            "a-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_ab_tlb div[dat" +
                            "a-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public Button Cancel { get; }
                ...
                public PxButtonCollection()
                {
                    Accept = new Button("ctl00_phG_DefaultCommissionSplitSP_PXDefaultCommissionSplitsOk", "Accept", "ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid");
                    Cancel = new Button("ctl00_phG_DefaultCommissionSplitSP_PXDefaultCommissionSplitsCancel", "Cancel", "ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid");
                }
            }
			...
			public PXNumberEdit CommissionSplitId { get; }
                ...
                public c_grid_row(c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid grid) : 
                        base(grid)
                {
                    Files = new FileColumnButton(null, "Files", grid.Locator, "Files");
                    Notes = new NoteColumnButton(null, "Notes", grid.Locator, "Notes");
                    SalesPersonId = new Selector("_ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0_edSplitSalesPe" +
                            "rsonId", "Salesperson ID", grid.Locator, "SalesPersonId");
                    SalesPersonId.DataField = "SalesPersonId";
                    SalesPersonId_SalesPerson_descr = new PXTextEdit("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_ei", "Name", grid.Locator, "SalesPersonId_SalesPerson_descr");
                    SalesPersonId_SalesPerson_descr.DataField = "SalesPersonId_SalesPerson_descr";
                    SalesPerson__UsrCWACRole = new DropDown("_ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0_ec", "Role", grid.Locator, "SalesPerson__UsrCWACRole");
                    SalesPerson__UsrCWACRole.DataField = "SalesPerson__UsrCWACRole";
                    SalesPerson__UsrCWACRole.Items.Add("S", "Salesperson");
                    SalesPerson__UsrCWACRole.Items.Add("M", "Manager");
                    SplitPercentage = new PXNumberEdit("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_en", "Commission Split %", grid.Locator, "SplitPercentage");
                    SplitPercentage.DataField = "SplitPercentage";
                    DollarAmt = new PXNumberEdit("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_en", "Dollar Amount", grid.Locator, "DollarAmt");
                    DollarAmt.DataField = "DollarAmt";
                    IsDefault = new CheckBox("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_ef", "Primary", grid.Locator, "IsDefault");
                    IsDefault.DataField = "IsDefault";
                    CommissionSplitId = new PXNumberEdit("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_en", "CommissionSplitId", grid.Locator, "CommissionSplitId");
                    CommissionSplitId.DataField = "CommissionSplitId";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
                ...
                public c_grid_header(c_cwacsalesordercommissionsplits_defaultcommissionsplitgrid grid) : 
                        base(grid)
                {
                    Files = new GridColumnHeader(grid.Row.Files);
                    Notes = new GridColumnHeader(grid.Row.Notes);
        ...
        public class c_cwacsalesordercommissionsplits_lv0 : Container
        {
            ...
            public c_cwacsalesordercommissionsplits_lv0(string locator, string name) : 
                    base(locator, name)
            {
                SalesPersonId = new Selector("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0_edSplitSalesPer" +
                        "sonId", "Salesperson ID", locator, null);
                SalesPersonIdLabel = new Label(SalesPersonId);
                SalesPersonId.DataField = "SalesPersonId";
                Es = new Selector("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ec = new DropDown("ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0_ec", "Ec", locator, null);
                DataMemberName = "CWACSalesOrderCommissionSplits";
                Buttons = new PxButtonCollection();
            }
			...
			public Button Cancel { get; }
                ...
                public PxButtonCollection()
                {
                    SalesPersonIdEdit = new Button("css=div[id=\'ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0_edS" +
                            "plitSalesPersonId\'] div[class=\'editBtnCont\'] > div > div", "SalesPersonIdEdit", "ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0");
                    SalesPersonIdEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                    Accept = new Button("ctl00_phG_DefaultCommissionSplitSP_PXDefaultCommissionSplitsOk", "Accept", "ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0");
                    Cancel = new Button("ctl00_phG_DefaultCommissionSplitSP_PXDefaultCommissionSplitsCancel", "Cancel", "ctl00_phG_DefaultCommissionSplitSP_DefaultCommissionSplitGrid_lv0");
                }
            }
        }
