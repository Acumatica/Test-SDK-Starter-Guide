...
using Controls.SplittedIconCell;
...
namespace GeneratedWrappers.SOLUTIONNAME
{
    ...
    public class CA306000_CABankTransactionsMaint : Wrapper
    {
        ...
        public c_tranfilter_form TranFilter_form { get; } = new c_tranfilter_form("ctl00_phG_PXSplitContainer_form", "TranFilter_form");
        ...
        public c_details_grid1 Details_grid1 { get; } = new c_details_grid1("ctl00_phG_PXSplitContainer_grid1", "Details_grid1");
        public c_details_lv0 Details_lv0 { get; } = new c_details_lv0("ctl00_phG_PXSplitContainer_grid1_lv0", "Details_lv0");
        public c_currentcabanktran_pxtaxformview1 CurrentCABankTran_PXTaxFormView1 { get; } = new c_currentcabanktran_pxtaxformview1("ctl00_phG_PXTaxPanel_PXTaxFormView1", "CurrentCABankTran_PXTaxFormView1");
        public c_detailsforpaymentcreation_frmcreatedocument DetailsForPaymentCreation_frmCreateDocument { get; } = new c_detailsforpaymentcreation_frmcreatedocument("ctl00_phG_PXSplitContainer_tab2_t3_frmCreateDocument", "DetailsForPaymentCreation_frmCreateDocument");
        public c_detailsforinvoiceapplication_frmcreatedocumentinv DetailsForInvoiceApplication_frmCreateDocumentInv { get; } = new c_detailsforinvoiceapplication_frmcreatedocumentinv("ctl00_phG_PXSplitContainer_tab2_t1_frmCreateDocumentInv", "DetailsForInvoiceApplication_frmCreateDocumentInv");
        public c_detailsforpaymentmatching_frmmatchtopayments DetailsForPaymentMatching_frmMatchToPayments { get; } = new c_detailsforpaymentmatching_frmmatchtopayments("ctl00_phG_PXSplitContainer_tab2_t0_frmMatchToPayments", "DetailsForPaymentMatching_frmMatchToPayments");
        public c_taxtrans_pxtaxgrid TaxTrans_PXTaxGrid { get; } = new c_taxtrans_pxtaxgrid("ctl00_phG_PXTaxPanel_PXTaxGrid", "TaxTrans_PXTaxGrid");
        public c_taxtrans_lv0 TaxTrans_lv0 { get; } = new c_taxtrans_lv0("ctl00_phG_PXTaxPanel_PXTaxGrid_lv0", "TaxTrans_lv0");
        public c_detailmatchesca_pxgrid1 DetailMatchesCA_PXGrid1 { get; } = new c_detailmatchesca_pxgrid1("ctl00_phG_PXSplitContainer_tab2_t0_PXGrid1", "DetailMatchesCA_PXGrid1");
        public c_detailmatchesca_lv0 DetailMatchesCA_lv0 { get; } = new c_detailmatchesca_lv0("ctl00_phG_PXSplitContainer_tab2_t0_PXGrid1_lv0", "DetailMatchesCA_lv0");
        public c_adjustments_gridadjustments Adjustments_gridAdjustments { get; } = new c_adjustments_gridadjustments("ctl00_phG_PXSplitContainer_tab2_t3_gridAdjustments", "Adjustments_gridAdjustments");
        public c_adjustments_lv0 Adjustments_lv0 { get; } = new c_adjustments_lv0("ctl00_phG_PXSplitContainer_tab2_t3_gridAdjustments_lv0", "Adjustments_lv0");
        public c_cashaccount_tabmatchsettings CashAccount_tabMatchSettings { get; } = new c_cashaccount_tabmatchsettings("ctl00_phG_pnlMatchSettings_tabMatchSettings", "cashAccount_tabMatchSettings");
        public c_detailmatchinginvoices_griddetailmatches4 DetailMatchingInvoices_gridDetailMatches4 { get; } = new c_detailmatchinginvoices_griddetailmatches4("ctl00_phG_PXSplitContainer_tab2_t1_gridDetailMatches4", "detailMatchingInvoices_gridDetailMatches4");
        public c_detailmatchinginvoices_lv0 DetailMatchingInvoices_lv0 { get; } = new c_detailmatchinginvoices_lv0("ctl00_phG_PXSplitContainer_tab2_t1_gridDetailMatches4_lv0", "detailMatchingInvoices_lv0");
        public c_expensereceiptdetailmatches_gridexpensereceiptdetailmatches ExpenseReceiptDetailMatches_gridExpenseReceiptDetailMatches { get; } = new c_expensereceiptdetailmatches_gridexpensereceiptdetailmatches("ctl00_phG_PXSplitContainer_tab2_t2_gridExpenseReceiptDetailMatches", "ExpenseReceiptDetailMatches_gridExpenseReceiptDetailMatches");
        public c_expensereceiptdetailmatches_lv0 ExpenseReceiptDetailMatches_lv0 { get; } = new c_expensereceiptdetailmatches_lv0("ctl00_phG_PXSplitContainer_tab2_t2_gridExpenseReceiptDetailMatches_lv0", "ExpenseReceiptDetailMatches_lv0");
        public c_transplit_gridcasplits TranSplit_gridCASplits { get; } = new c_transplit_gridcasplits("ctl00_phG_PXSplitContainer_tab2_t3_gridCASplits", "TranSplit_gridCASplits");
        public c_transplit_lv0 TranSplit_lv0 { get; } = new c_transplit_lv0("ctl00_phG_PXSplitContainer_tab2_t3_gridCASplits_lv0", "TranSplit_lv0");
        public c_loadopts_loform LoadOpts_loform { get; } = new c_loadopts_loform("ctl00_phG_pnlLoadOpts_loform", "loadOpts_loform");
        public c_rulecreation_frmcreaterule RuleCreation_frmCreateRule { get; } = new c_rulecreation_frmcreaterule("ctl00_phG_pnlCreateRule_frmCreateRule", "RuleCreation_frmCreateRule");
        ...
        public c_screen_upload StatementFileUpload { get; } = new c_screen_upload("ctl00_phG_PXSplitContainer_pnlNewRev", "StatementFileUpload");
        ...
        public class c_details_grid1 : Grid<c_details_grid1.c_grid_row, c_details_grid1.c_grid_header>
        {
			...
			public SplittedIconCell SplittedIcon { get; }
			...
			public PXTextEdit CuryOrigDebitAmt { get; }
			public PXTextEdit CuryOrigCreditAmt { get; }
			...
			public PXTextEdit MatchStatsInfo { get; }
                        ...
                        base(grid)
                {
                    ...
                    SplittedIcon = new SplittedIconCell(null, "SplittedIcon", grid.Locator, "SplittedIcon");
                    ...
                    TranDate = new DateSelector("_ctl00_phG_PXSplitContainer_grid1_lv0_ed8", "Tran. Date", grid.Locator, "TranDate");
                    ...
                    CuryOrigDebitAmt = new PXTextEdit("ctl00_phG_PXSplitContainer_grid1", "Orig. Receipt", grid.Locator, "CuryOrigDebitAmt");
                    CuryOrigDebitAmt.DataField = "CuryOrigDebitAmt";
                    CuryOrigCreditAmt = new PXTextEdit("ctl00_phG_PXSplitContainer_grid1", "Orig. Disbursement", grid.Locator, "CuryOrigCreditAmt");
                    CuryOrigCreditAmt.DataField = "CuryOrigCreditAmt";
            ...
            public class c_grid_header : GridHeader
            {
				...
				public GridColumnHeader SplittedIcon { get; }
				...
				public PXTextEditColumnFilter CuryOrigDebitAmt { get; }
				public PXTextEditColumnFilter CuryOrigCreditAmt { get; }
                        ...
                        base(grid)
                {
                    ...
                    SplittedIcon = new GridColumnHeader(grid.Row.SplittedIcon);
                    ...
                    CuryOrigDebitAmt = new PXTextEditColumnFilter(grid.Row.CuryOrigDebitAmt);
                    CuryOrigCreditAmt = new PXTextEditColumnFilter(grid.Row.CuryOrigCreditAmt);
        ...
        public class c_detailmatchesca_pxgrid1 : Grid<c_detailmatchesca_pxgrid1.c_grid_row, c_detailmatchesca_pxgrid1.c_grid_header>
        {
			...
			public PXTextEdit ExtRefNbr { get; }
			public DropDown OrigModule { get; }
			public DropDown OrigTranTypeUI { get; }
			public DropDown Status { get; }
			public PXTextEdit TranDesc { get; }
			public PXTextEdit FinPeriodID { get; }
			public PXNumberEdit CuryTranAbsAmt { get; }
			public PXNumberEdit CuryTranAmtCalc { get; }
			public Selector BAccount__AcctCD { get; }
			public PXTextEdit BAccount__AcctName { get; }
			public Selector TranID { get; }
                        ...
                        base(grid)
                {
                    ...
                    OrigTranTypeUI = new DropDown("_ctl00_phG_PXSplitContainer_tab2_t0_PXGrid1_lv0_ec", "Tran. Type", grid.Locator, "OrigTranTypeUI");
                    OrigTranTypeUI.DataField = "OrigTranTypeUI";
                    OrigTranTypeUI.Items.Add("CTO", "Transfer Out");
                    OrigTranTypeUI.Items.Add("CTI", "Transfer In");
                    OrigTranTypeUI.Items.Add("CTE", "Expense Entry");
                    OrigTranTypeUI.Items.Add("CAE", "Cash Entry");
                    OrigTranTypeUI.Items.Add("CDT", "CA Deposit");
                    OrigTranTypeUI.Items.Add("CVD", "CA Void Deposit");
                    OrigTranTypeUI.Items.Add("CT%", "Transfer");
                    OrigTranTypeUI.Items.Add("GLE", "GL Entry");
                    OrigTranTypeUI.Items.Add("CBT", "AP Batch");
                    OrigTranTypeUI.Items.Add("ACR", "Credit Adj.");
                    ...
                    OrigTranTypeUI.Items.Add("PMT", "Payment");
                    OrigTranTypeUI.Items.Add("RPM", "Voided Payment");
                    OrigTranTypeUI.Items.Add("FCH", "Overdue Charge");
                    OrigTranTypeUI.Items.Add("SMB", "Balance WO");
                    ...
                    OrigTranTypeUI.Items.Add("VRF", "Voided Refund");
                    OrigTranTypeUI.Items.Add("ECD", "Expense Receipt");
                    Status = new DropDown("_ctl00_phG_PXSplitContainer_tab2_t0_PXGrid1_lv0_ec", "Status", grid.Locator, "Status");
                    Status.DataField = "Status";
                    ...
                    BAccount__AcctCD = new Selector("_ctl00_phG_PXSplitContainer_tab2_t0_PXGrid1_lv0_es", "Business Account", grid.Locator, "BAccount__AcctCD");
                    BAccount__AcctCD.DataField = "BAccount__AcctCD";
                    BAccount__AcctName = new PXTextEdit("ctl00_phG_PXSplitContainer_tab2_t0_PXGrid1_ei", "Business Account Name", grid.Locator, "BAccount__AcctName");
                    BAccount__AcctName.DataField = "BAccount__AcctName";
            ...
            public class c_grid_header : GridHeader
            {
				...
				public DropDownColumnFilter OrigTranTypeUI { get; }
				public DropDownColumnFilter Status { get; }
				public PXTextEditColumnFilter TranDesc { get; }
				...
				public SelectorColumnFilter BAccount__AcctCD { get; }
				public PXTextEditColumnFilter BAccount__AcctName { get; }
                        ...
                        base(grid)
                {
                    ...
                    OrigTranTypeUI = new DropDownColumnFilter(grid.Row.OrigTranTypeUI);
                    Status = new DropDownColumnFilter(grid.Row.Status);
                    TranDesc = new PXTextEditColumnFilter(grid.Row.TranDesc);
                    ...
                    BAccount__AcctCD = new SelectorColumnFilter(grid.Row.BAccount__AcctCD);
                    BAccount__AcctName = new PXTextEditColumnFilter(grid.Row.BAccount__AcctName);
        ...
        public class c_adjustments_gridadjustments : Grid<c_adjustments_gridadjustments.c_grid_row, c_adjustments_gridadjustments.c_grid_header>
        {
			...
			public Selector AdjdCuryID { get; }
			...
			public PXNumberEdit AdjNbr { get; }
                        ...
                        base(grid)
                {
                    ...
                    AdjdCuryID = new Selector("_ctl00_phG_PXSplitContainer_tab2_t3_gridAdjustments_lv0_es", "Currency", grid.Locator, "AdjdCuryID");
                    ...
                    CuryOrigDocAmt = new PXNumberEdit("ctl00_phG_PXSplitContainer_tab2_t3_gridAdjustments_en", "Invoice Amount", grid.Locator, "CuryOrigDocAmt");
            ...
            public class c_grid_header : GridHeader
            {
				...
				public SelectorColumnFilter AdjdCuryID { get; }
                        ...
                        base(grid)
                {
                    ...
                    AdjdCuryID = new SelectorColumnFilter(grid.Row.AdjdCuryID);
        ...
        public class c_cashaccount_tabmatchsettings : Container
        {
            ...
            public virtual void ResetMatchSettingsToDefault()
            {
                Buttons.ResetMatchSettingsToDefault.Click();
            }
			...
			public Button ResetMatchSettingsToDefault { get; }
			public Button SaveClose { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    ResetMatchSettingsToDefault = new Button("ctl00_phG_pnlMatchSettings_btnResetToDefault", "Reset to Default", "ctl00_phG_pnlMatchSettings_tabMatchSettings");
        ...
        public class c_detailmatchinginvoices_griddetailmatches4 : Grid<c_detailmatchinginvoices_griddetailmatches4.c_grid_row, c_detailmatchinginvoices_griddetailmatches4.c_grid_header>
        {
			...
			public PXTextEdit TranDesc { get; }
                        ...
                        base(grid)
                {
                    ...
                    OrigTranType.Items.Add("QCK", "Cash Purchase");
                    OrigTranType.Items.Add("CHK", "Payment");
