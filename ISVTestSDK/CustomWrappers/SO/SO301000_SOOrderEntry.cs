...
namespace GeneratedWrappers.ISVTEST
{
    ...
    public class SO301000_SOOrderEntry : Wrapper
    {
        ...
        protected c_currentdocument_formfreightinfo CurrentDocument_formFreightInfo { get; } = new c_currentdocument_formfreightinfo("ctl00_phG_tab_t13_formFreightInfo", "CurrentDocument_formFreightInfo");
        protected c_currentdocument_formordertotals CurrentDocument_formOrderTotals { get; } = new c_currentdocument_formordertotals("ctl00_phG_tab_t13_formOrderTotals", "CurrentDocument_formOrderTotals");
        protected c_currentdocument_formcalculatedamounts CurrentDocument_formCalculatedAmounts { get; } = new c_currentdocument_formcalculatedamounts("ctl00_phG_tab_t13_formCalculatedAmounts", "CurrentDocument_formCalculatedAmounts");
        ...
        protected c_rutrots_rutrotform Rutrots_RUTROTForm { get; } = new c_rutrots_rutrotform("ctl00_phG_tab_t14_RUTROTForm", "Rutrots_RUTROTForm");
        ...
        protected c_rrdistribution_griddistribution RRDistribution_gridDistribution { get; } = new c_rrdistribution_griddistribution("ctl00_phG_tab_t14_RUTROTForm_gridDistribution", "RRDistribution_gridDistribution");
        protected c_rrdistribution_lv0 RRDistribution_lv0 { get; } = new c_rrdistribution_lv0("ctl00_phG_tab_t14_RUTROTForm_gridDistribution_lv0", "RRDistribution_lv0");
        ...
        public virtual void PrintBlanket()
        {
            ToolBar.PrintBlanket.Click();
        }
        ...
        public virtual void EmailBlanket()
        {
            ToolBar.EmailBlanket.Click();
        }
        ...
        public virtual void CreateChildOrders()
        {
            ToolBar.CreateChildOrders.Click();
        }
        
        public virtual void CreateChildOrders(bool status, string message = null)
        {
            ToolBar.CreateChildOrders.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CreateChildOrders.Click();
        }
        
        public virtual void ProcessExpiredOrder()
        {
            ToolBar.ProcessExpiredOrder.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton CreateChildOrders { get; }
			public ToolBarButton ProcessExpiredOrder { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                PrintBlanket = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_PrintBlanket,#ctl00_phDS_ds_ToolBar_PrintBlanket_item", "Print Blanket Sales Order", locator, MenuOpener);
                ...
                EmailBlanket = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_EmailBlanket,#ctl00_phDS_ds_ToolBar_EmailBlanket_item", "Email Blanket Sales Order", locator, MenuOpener);
                ...
                CreateChildOrders = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_CreateChildOrders,#ctl00_phDS_ds_ToolBar_CreateChildOr" +
                        "ders_item", "Create Child Orders", locator, MenuOpener);
                CreateChildOrders.WaitAction = Wait.WaitForLongOperationToComplete;
                ProcessExpiredOrder = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar_ProcessExpiredOrder,#ctl00_phDS_ds_ToolBar_ProcessExpi" +
                        "redOrder_item", "Process Expired Order", locator, MenuOpener);
        ...
        public class c_document_form : Container
        {
			...
			public CheckBox ShowDiscountsTab { get; }
			public Label ShowDiscountsTabLabel { get; }
			public CheckBox ShowShipmentsTab { get; }
			public Label ShowShipmentsTabLabel { get; }
			public CheckBox ShowOrdersTab { get; }
			public Label ShowOrdersTabLabel { get; }
                    ...
                    base(locator, name)
            {
                ...
                ExpireDate = new DateSelector("ctl00_phF_form_t0_edExpireDate", "Expires On", locator, null);
                ...
                ShowDiscountsTab = new CheckBox("ctl00_phF_form_t0_chkShowDiscountsTab", "ShowDiscountsTab", locator, null);
                ShowDiscountsTabLabel = new Label(ShowDiscountsTab);
                ShowDiscountsTab.DataField = "ShowDiscountsTab";
                ShowShipmentsTab = new CheckBox("ctl00_phF_form_t0_chkShowShipmentsTab", "ShowShipmentsTab", locator, null);
                ShowShipmentsTabLabel = new Label(ShowShipmentsTab);
                ShowShipmentsTab.DataField = "ShowShipmentsTab";
                ShowOrdersTab = new CheckBox("ctl00_phF_form_t0_chkShowOrdersTab", "ShowOrdersTab", locator, null);
                ShowOrdersTabLabel = new Label(ShowOrdersTab);
                ShowOrdersTab.DataField = "ShowOrdersTab";
            ...
            public virtual void CustomerLocationIDEdit()
            {
                Buttons.CustomerLocationIDEdit.Click();
            }
			...
			public Button CustomerLocationIDEdit { get; }
			...
			public Button ProjectIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    CustomerLocationIDEdit = new Button("css=div[id=\'ctl00_phF_form_t0_edCustomerLocationID\'] div[class=\'editBtnCont\'] > d" +
                            "iv > div", "CustomerLocationIDEdit", "ctl00_phF_form");
                    CustomerLocationIDEdit.WaitAction = Wait.WaitForNewWindowToOpen;
        ...
        public class c_currentdocument_formpt : Container
        {
			...
			public PXNumberEdit CuryTransferredToChildrenPaymentTotal { get; }
			public Label CuryTransferredToChildrenPaymentTotalLabel { get; }
        ...
        public class c_currentdocument_formfreightinfo : Container
        {
            ...
            public c_currentdocument_formfreightinfo(string locator, string name) : 
                    base(locator, name)
            {
                OrderWeight = new PXNumberEdit("ctl00_phG_tab_t13_formFreightInfo_edOrderWeight", "Order Weight", locator, null);
                OrderWeightLabel = new Label(OrderWeight);
                OrderWeight.DataField = "OrderWeight";
                OrderVolume = new PXNumberEdit("ctl00_phG_tab_t13_formFreightInfo_edOrderVolume", "Order Volume", locator, null);
                OrderVolumeLabel = new Label(OrderVolume);
                OrderVolume.DataField = "OrderVolume";
                PackageWeight = new PXNumberEdit("ctl00_phG_tab_t13_formFreightInfo_edPackageWeight", "Package Weight", locator, null);
                PackageWeightLabel = new Label(PackageWeight);
                PackageWeight.DataField = "PackageWeight";
                CuryFreightCost = new PXNumberEdit("ctl00_phG_tab_t13_formFreightInfo_edCuryFreightCost", "Freight Cost", locator, null);
                CuryFreightCostLabel = new Label(CuryFreightCost);
                CuryFreightCost.DataField = "CuryFreightCost";
                FreightCostIsValid = new CheckBox("ctl00_phG_tab_t13_formFreightInfo_chkFreightCostIsValid", "Freight Cost Is up-to-date", locator, null);
                FreightCostIsValidLabel = new Label(FreightCostIsValid);
                FreightCostIsValid.DataField = "FreightCostIsValid";
                OverrideFreightAmount = new CheckBox("ctl00_phG_tab_t13_formFreightInfo_chkOverrideFreightAmount", "Override Freight Price", locator, null);
                OverrideFreightAmountLabel = new Label(OverrideFreightAmount);
                OverrideFreightAmount.DataField = "OverrideFreightAmount";
                FreightAmountSource = new DropDown("ctl00_phG_tab_t13_formFreightInfo_edFreightAmountSource", "Invoice Freight Price Based On", locator, null);
                ...
                CuryFreightAmt = new PXNumberEdit("ctl00_phG_tab_t13_formFreightInfo_edCuryFreightAmt", "Freight Price", locator, null);
                CuryFreightAmtLabel = new Label(CuryFreightAmt);
                CuryFreightAmt.DataField = "CuryFreightAmt";
                CuryPremiumFreightAmt = new PXNumberEdit("ctl00_phG_tab_t13_formFreightInfo_edCuryPremiumFreightAmt", "Premium Freight Price", locator, null);
                CuryPremiumFreightAmtLabel = new Label(CuryPremiumFreightAmt);
                CuryPremiumFreightAmt.DataField = "CuryPremiumFreightAmt";
                FreightTaxCategoryID = new Selector("ctl00_phG_tab_t13_formFreightInfo_edFreightTaxCategoryID", "Freight Tax Category", locator, null);
			...
			public Button RefreshFreightCost { get; }
                ...
                public PxButtonCollection()
                {
                    RefreshFreightCost = new Button("ctl00_phG_tab_t13_formFreightInfo_checkFreightRate", "Refresh Freight Cost", "ctl00_phG_tab_t13_formFreightInfo");
                }
            }
        }
        ...
        public class c_currentdocument_formordertotals : Container
        {
            ...
            public c_currentdocument_formordertotals(string locator, string name) : 
                    base(locator, name)
            {
                AMCuryEstimateTotal = new PXNumberEdit("ctl00_phG_tab_t13_formOrderTotals_edAMCuryEstimateTotal", "Estimate Total", locator, null);
                AMCuryEstimateTotalLabel = new Label(AMCuryEstimateTotal);
                AMCuryEstimateTotal.DataField = "AMCuryEstimateTotal";
                CuryLineTotal = new PXNumberEdit("ctl00_phG_tab_t13_formOrderTotals_edCuryLineTotal", "Line Total", locator, null);
                CuryLineTotalLabel = new Label(CuryLineTotal);
                CuryLineTotal.DataField = "CuryLineTotal";
                CuryMiscTot = new PXNumberEdit("ctl00_phG_tab_t13_formOrderTotals_edCuryMiscTot", "Misc. Total", locator, null);
                CuryMiscTotLabel = new Label(CuryMiscTot);
                CuryMiscTot.DataField = "CuryMiscTot";
                CuryTaxTotal = new PXNumberEdit("ctl00_phG_tab_t13_formOrderTotals_edCuryTaxTotal", "Tax Total", locator, null);
                CuryTaxTotalLabel = new Label(CuryTaxTotal);
                CuryTaxTotal.DataField = "CuryTaxTotal";
                DataMemberName = "CurrentDocument";
                Buttons = new PxButtonCollection();
			...
			public Button RefreshFreightCost { get; }
                ...
                public PxButtonCollection()
                {
                    RefreshFreightCost = new Button("ctl00_phG_tab_t13_formFreightInfo_checkFreightRate", "Refresh Freight Cost", "ctl00_phG_tab_t13_formOrderTotals");
                }
            }
        }
        ...
        public class c_currentdocument_formcalculatedamounts : Container
        {
			...
			public PXNumberEdit BlanketOpenQty { get; }
			public Label BlanketOpenQtyLabel { get; }
            ...
            public c_currentdocument_formcalculatedamounts(string locator, string name) : 
                    base(locator, name)
            {
                AMEstimateQty = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edAMEstimateQty", "Estimate Qty", locator, null);
                AMEstimateQtyLabel = new Label(AMEstimateQty);
                AMEstimateQty.DataField = "AMEstimateQty";
                BlanketOpenQty = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edBlanketOpenQty", "Open Quantity", locator, null);
                BlanketOpenQtyLabel = new Label(BlanketOpenQty);
                BlanketOpenQty.DataField = "BlanketOpenQty";
                OpenOrderQty = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edOpenOrderQty", "Unshipped Quantity", locator, null);
                OpenOrderQtyLabel = new Label(OpenOrderQty);
                OpenOrderQty.DataField = "OpenOrderQty";
                CuryOpenOrderTotal = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edCuryOpenOrderTotal", "Unshipped Amount", locator, null);
                CuryOpenOrderTotalLabel = new Label(CuryOpenOrderTotal);
                CuryOpenOrderTotal.DataField = "CuryOpenOrderTotal";
                UnbilledOrderQty = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edUnbilledOrderQty", "Unbilled Quantity", locator, null);
                UnbilledOrderQtyLabel = new Label(UnbilledOrderQty);
                UnbilledOrderQty.DataField = "UnbilledOrderQty";
                CuryUnbilledOrderTotal = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edCuryUnbilledOrderTotal", "Unbilled Balance", locator, null);
                CuryUnbilledOrderTotalLabel = new Label(CuryUnbilledOrderTotal);
                CuryUnbilledOrderTotal.DataField = "CuryUnbilledOrderTotal";
                CuryPaymentTotal = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edCuryPaymentTotal", "Total Paid", locator, null);
                CuryPaymentTotalLabel = new Label(CuryPaymentTotal);
                CuryPaymentTotal.DataField = "CuryPaymentTotal";
                CuryUnpaidBalance = new PXNumberEdit("ctl00_phG_tab_t13_formCalculatedAmounts_edCuryUnpaidBalance1", "Unpaid Balance", locator, null);
                CuryUnpaidBalanceLabel = new Label(CuryUnpaidBalance);
                CuryUnpaidBalance.DataField = "CuryUnpaidBalance";
                DataMemberName = "CurrentDocument";
                Buttons = new PxButtonCollection();
			...
			public Button RefreshFreightCost { get; }
                ...
                public PxButtonCollection()
                {
                    RefreshFreightCost = new Button("ctl00_phG_tab_t13_formFreightInfo_checkFreightRate", "Refresh Freight Cost", "ctl00_phG_tab_t13_formCalculatedAmounts");
                }
            }
        }
        ...
        public class c_rutrots_rutrotform : Container
        {
            ...
            public c_rutrots_rutrotform(string locator, string name) : 
                    base(locator, name)
            {
                AutoDistribution = new CheckBox("ctl00_phG_tab_t14_RUTROTForm_chkRRAutoDistribution", "Distribute Automatically", locator, null);
                AutoDistributionLabel = new Label(AutoDistribution);
                AutoDistribution.DataField = "AutoDistribution";
                RUTROTType = new GroupBox("ctl00_phG_tab_t14_RUTROTForm_gbRRType", "RUTROT Type", locator, null);
                RUTROTTypeLabel = new Label(RUTROTType);
                RUTROTType.DataField = "RUTROTType";
                ROTAppartment = new PXTextEdit("ctl00_phG_tab_t14_RUTROTForm_edRAppartment", "Apartment", locator, null);
                ROTAppartmentLabel = new Label(ROTAppartment);
                ROTAppartment.DataField = "ROTAppartment";
                ROTEstate = new PXTextEdit("ctl00_phG_tab_t14_RUTROTForm_edRREstate", "Real estate", locator, null);
                ROTEstateLabel = new Label(ROTEstate);
                ROTEstate.DataField = "ROTEstate";
                ROTOrganizationNbr = new PXTextEdit("ctl00_phG_tab_t14_RUTROTForm_edRROrganizationNbr", "Organization nbr.", locator, null);
                ROTOrganizationNbrLabel = new Label(ROTOrganizationNbr);
                ROTOrganizationNbr.DataField = "ROTOrganizationNbr";
                DeductionPct = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_edRRDeduction", "Deduction,%", locator, null);
                DeductionPctLabel = new Label(DeductionPct);
                DeductionPct.DataField = "DeductionPct";
                CuryTotalAmt = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_edRRTotalAmt", "Total Deductible Amount", locator, null);
                CuryTotalAmtLabel = new Label(CuryTotalAmt);
                CuryTotalAmt.DataField = "CuryTotalAmt";
                CuryOtherCost = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_edRUTROTOtherCost", "Other Cost", locator, null);
                CuryOtherCostLabel = new Label(CuryOtherCost);
                CuryOtherCost.DataField = "CuryOtherCost";
                CuryMaterialCost = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_edRUTROTMaterialCost", "Material Cost", locator, null);
                CuryMaterialCostLabel = new Label(CuryMaterialCost);
                CuryMaterialCost.DataField = "CuryMaterialCost";
                CuryWorkPrice = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_edRUTROTWorkPrice", "Work Price", locator, null);
                CuryWorkPriceLabel = new Label(CuryWorkPrice);
                CuryWorkPrice.DataField = "CuryWorkPrice";
                CuryDistributedAmt = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_edRRAvailAmt", "Distributed Amount", locator, null);
                CuryDistributedAmtLabel = new Label(CuryDistributedAmt);
                CuryDistributedAmt.DataField = "CuryDistributedAmt";
                CuryUndistributedAmt = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_edRRUndsitributedAmt", "Undistributed Amount", locator, null);
        ...
        public class c_transactions_grid : Grid<c_transactions_grid.c_grid_row, c_transactions_grid.c_grid_header>
        {
            ...
            public virtual void AddBlanketLine()
            {
			...
			public PXNumberEdit QtyOnOrders { get; }
			public PXNumberEdit BlanketOpenQty { get; }
			public PXNumberEdit UnshippedQty { get; }
			...
			public Selector ShipTermsID { get; }
			public Selector ShipZoneID { get; }
			public DateSelector SchedShipDate { get; }
			public Selector TaxZoneID { get; }
			...
			public DateSelector POCreateDate { get; }
			...
			public Selector AMConfigKeyID { get; }
                        ...
                        base(grid)
                {
                    ...
                    QtyOnOrders = new PXNumberEdit("_ctl00_phG_tab_t0_grid_lv0_edQtyOnOrders", "Qty. On Orders", grid.Locator, "QtyOnOrders");
                    QtyOnOrders.DataField = "QtyOnOrders";
                    BlanketOpenQty = new PXNumberEdit("_ctl00_phG_tab_t0_grid_lv0_edBlanketOpenQty", "Blanket Open Qty.", grid.Locator, "BlanketOpenQty");
                    BlanketOpenQty.DataField = "BlanketOpenQty";
                    UnshippedQty = new PXNumberEdit("_ctl00_phG_tab_t0_grid_lv0_edUnshippedQty", "Unshipped Qty.", grid.Locator, "UnshippedQty");
                    UnshippedQty.DataField = "UnshippedQty";
                    ...
                    AutomaticDiscountsDisabled = new CheckBox("_ctl00_phG_tab_t0_grid_lv0_chkAutomaticDiscountsDisabled", "Automatic Discounts Disabled", grid.Locator, "AutomaticDiscountsDisabled");
                    ...
                    CustomerOrderNbr.DataField = "CustomerOrderNbr";
                    CustomerLocationID = new Selector("_ctl00_phG_tab_t0_grid_lv0_edCustomerLocationIDLine", "Ship-To Location", grid.Locator, "CustomerLocationID");
                    CustomerLocationID.DataField = "CustomerLocationID";
                    CustomerLocationID_Location_descr = new PXTextEdit("ctl00_phG_tab_t0_grid_ei", "Location Name", grid.Locator, "CustomerLocationID_Location_descr");
                    CustomerLocationID_Location_descr.DataField = "CustomerLocationID_Location_descr";
                    ShipVia = new Selector("_ctl00_phG_tab_t0_grid_lv0_es", "Ship Via", grid.Locator, "ShipVia");
                    ShipVia.DataField = "ShipVia";
                    FOBPoint = new Selector("_ctl00_phG_tab_t0_grid_lv0_es", "FOB", grid.Locator, "FOBPoint");
                    FOBPoint.DataField = "FOBPoint";
                    ShipTermsID = new Selector("_ctl00_phG_tab_t0_grid_lv0_es", "Shipping Terms", grid.Locator, "ShipTermsID");
                    ShipTermsID.DataField = "ShipTermsID";
                    ShipZoneID = new Selector("_ctl00_phG_tab_t0_grid_lv0_es", "Shipping Zone", grid.Locator, "ShipZoneID");
                    ShipZoneID.DataField = "ShipZoneID";
                    SchedShipDate = new DateSelector("_ctl00_phG_tab_t0_grid_lv0_edSchedShipDate", "Sched. Shipment Date", grid.Locator, "SchedShipDate");
                    SchedShipDate.DataField = "SchedShipDate";
                    TaxZoneID = new Selector("_ctl00_phG_tab_t0_grid_lv0_edTaxZoneID", "Tax Zone", grid.Locator, "TaxZoneID");
                    TaxZoneID.DataField = "TaxZoneID";
                    ...
                    POCreateDate = new DateSelector("_ctl00_phG_tab_t0_grid_lv0_edPOCreateDate", "PO Creation Date", grid.Locator, "POCreateDate");
                    POCreateDate.DataField = "POCreateDate";
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXNumberEditColumnFilter QtyOnOrders { get; }
				public PXNumberEditColumnFilter BlanketOpenQty { get; }
				public PXNumberEditColumnFilter UnshippedQty { get; }
				...
				public SelectorColumnFilter FOBPoint { get; }
				public SelectorColumnFilter ShipTermsID { get; }
				public SelectorColumnFilter ShipZoneID { get; }
				public DateSelectorColumnFilter SchedShipDate { get; }
				...
				public DateSelectorColumnFilter POCreateDate { get; }
                        ...
                        base(grid)
                {
                    ...
                    QtyOnOrders = new PXNumberEditColumnFilter(grid.Row.QtyOnOrders);
                    BlanketOpenQty = new PXNumberEditColumnFilter(grid.Row.BlanketOpenQty);
                    UnshippedQty = new PXNumberEditColumnFilter(grid.Row.UnshippedQty);
                    ...
                    FOBPoint = new SelectorColumnFilter(grid.Row.FOBPoint);
                    ShipTermsID = new SelectorColumnFilter(grid.Row.ShipTermsID);
                    ShipZoneID = new SelectorColumnFilter(grid.Row.ShipZoneID);
                    SchedShipDate = new DateSelectorColumnFilter(grid.Row.SchedShipDate);
                    ...
                    POCreateDate = new DateSelectorColumnFilter(grid.Row.POCreateDate);
        ...
        public class c_transactions_lv0 : Container
        {
			...
			public Label OrderQtyLabel { get; }
			public PXNumberEdit QtyOnOrders { get; }
			public Label QtyOnOrdersLabel { get; }
			public PXNumberEdit BlanketOpenQty { get; }
			public Label BlanketOpenQtyLabel { get; }
			public PXNumberEdit UnshippedQty { get; }
			public Label UnshippedQtyLabel { get; }
			public PXNumberEdit ShippedQty { get; }
			...
			public CheckBox AutomaticDiscountsDisabled { get; }
			public Label AutomaticDiscountsDisabledLabel { get; }
			public CheckBox Completed { get; }
			...
			public Label CustomerLocationIDLabel { get; }
			public DateSelector SchedShipDate { get; }
			public Label SchedShipDateLabel { get; }
			public PXNumberEdit CuryUnbilledAmt { get; }
			...
			public DateSelector POCreateDate { get; }
			public Label POCreateDateLabel { get; }
			public Selector POOrderNbr { get; }
                    ...
                    base(locator, name)
            {
                ...
                OrderQtyLabel = new Label(OrderQty);
                OrderQty.DataField = "OrderQty";
                QtyOnOrders = new PXNumberEdit("ctl00_phG_tab_t0_grid_lv0_edQtyOnOrders", "Qty. On Orders", locator, null);
                QtyOnOrdersLabel = new Label(QtyOnOrders);
                QtyOnOrders.DataField = "QtyOnOrders";
                BlanketOpenQty = new PXNumberEdit("ctl00_phG_tab_t0_grid_lv0_edBlanketOpenQty", "Blanket Open Qty.", locator, null);
                BlanketOpenQtyLabel = new Label(BlanketOpenQty);
                BlanketOpenQty.DataField = "BlanketOpenQty";
                UnshippedQty = new PXNumberEdit("ctl00_phG_tab_t0_grid_lv0_edUnshippedQty", "Unshipped Qty.", locator, null);
                UnshippedQtyLabel = new Label(UnshippedQty);
                UnshippedQty.DataField = "UnshippedQty";
                ...
                ManualDisc.DataField = "ManualDisc";
                AutomaticDiscountsDisabled = new CheckBox("ctl00_phG_tab_t0_grid_lv0_chkAutomaticDiscountsDisabled", "Automatic Discounts Disabled", locator, null);
                AutomaticDiscountsDisabledLabel = new Label(AutomaticDiscountsDisabled);
                AutomaticDiscountsDisabled.DataField = "AutomaticDiscountsDisabled";
                ...
                SchedOrderDate.DataField = "SchedOrderDate";
                CustomerOrderNbr = new PXTextEdit("ctl00_phG_tab_t0_grid_lv0_edCustomerOrderNbr", "Customer Order Nbr.", locator, null);
                CustomerOrderNbrLabel = new Label(CustomerOrderNbr);
                CustomerOrderNbr.DataField = "CustomerOrderNbr";
                CustomerLocationID = new Selector("ctl00_phG_tab_t0_grid_lv0_edCustomerLocationIDLine", "Ship-To Location", locator, null);
                CustomerLocationIDLabel = new Label(CustomerLocationID);
                CustomerLocationID.DataField = "CustomerLocationID";
                SchedShipDate = new DateSelector("ctl00_phG_tab_t0_grid_lv0_edSchedShipDate", "Sched. Shipment Date", locator, null);
                SchedShipDateLabel = new Label(SchedShipDate);
                SchedShipDate.DataField = "SchedShipDate";
                ...
                POSource.Items.Add("O", "Purchase to Order");
                POSource.Items.Add("B", "Blanket for Normal");
                POCreateDate = new DateSelector("ctl00_phG_tab_t0_grid_lv0_edPOCreateDate", "PO Creation Date", locator, null);
                POCreateDateLabel = new Label(POCreateDate);
                POCreateDate.DataField = "POCreateDate";
                ...
                SalesPersonIDLabel = new Label(SalesPersonID);
                SalesPersonID.DataField = "SalesPersonID";
                TaxZoneID = new Selector("ctl00_phG_tab_t0_grid_lv0_edTaxZoneID", "Tax Zone", locator, null);
                TaxZoneIDLabel = new Label(TaxZoneID);
                TaxZoneID.DataField = "TaxZoneID";
        ...
        public class c_taxes_grid1 : Grid<c_taxes_grid1.c_grid_row, c_taxes_grid1.c_grid_header>
        {
			...
			public PXNumberEdit RecordID { get; }
                ...
                public c_grid_row(c_taxes_grid1 grid) : 
                        base(grid)
                {
                    TaxZoneID = new PXTextEdit("_ctl00_phG_tab_t2_grid1_lv0_edTaxZoneID2", "Customer Tax Zone", grid.Locator, "TaxZoneID");
                    TaxZoneID.DataField = "TaxZoneID";
        ...
        public class c_taxes_lv0 : Container
        {
            ...
            public c_taxes_lv0(string locator, string name) : 
                    base(locator, name)
            {
                TaxZoneID = new PXTextEdit("ctl00_phG_tab_t2_grid1_lv0_edTaxZoneID2", "Tax Zone ID", locator, null);
                TaxZoneIDLabel = new Label(TaxZoneID);
                TaxZoneID.DataField = "TaxZoneID";
        ...
        public class c_discountdetails_formdiscountdetail : Grid<c_discountdetails_formdiscountdetail.c_grid_row, c_discountdetails_formdiscountdetail.c_grid_header>
        {
			...
			public PXTextEdit OrderNbr { get; }
                        ...
                        base(grid)
                {
                    ...
                    LineNbr = new PXTextEdit("ctl00_phG_tab_t8_formDiscountDetail", "Line Nbr.", grid.Locator, "LineNbr");
                    LineNbr.DataField = "LineNbr";
        ...
        public class c_recalcdiscountsfilter_formrecalcdiscounts : Container
        {
			...
			public CheckBox CalcDiscountsOnLinesWithDisabledAutomaticDiscounts { get; }
			public Label CalcDiscountsOnLinesWithDisabledAutomaticDiscountsLabel { get; }
                    ...
                    base(locator, name)
            {
                ...
                CalcDiscountsOnLinesWithDisabledAutomaticDiscounts = new CheckBox("ctl00_phG_PanelRecalcDiscounts_formRecalcDiscounts_chkCalcDiscountsOnLinesWithDis" +
                        "abledAutomaticDiscounts", "Calc Discounts On Lines With Disabled Automatic Discounts", locator, null);
                CalcDiscountsOnLinesWithDisabledAutomaticDiscountsLabel = new Label(CalcDiscountsOnLinesWithDisabledAutomaticDiscounts);
                CalcDiscountsOnLinesWithDisabledAutomaticDiscounts.DataField = "CalcDiscountsOnLinesWithDisabledAutomaticDiscounts";
        ...
        public class c_adjustments_detgrid : Grid<c_adjustments_detgrid.c_grid_row, c_adjustments_detgrid.c_grid_header>
        {
			...
			public PXNumberEdit CuryAdjdTransferredToChildrenAmt { get; }
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXNumberEditColumnFilter CuryAdjdTransferredToChildrenAmt { get; }
                        ...
                        base(grid)
                {
                    ...
                    CuryAdjdTransferredToChildrenAmt = new PXNumberEditColumnFilter(grid.Row.CuryAdjdTransferredToChildrenAmt);
        ...
        public class c_adjustments_lv0 : Container
        {
			...
			public PXNumberEdit CuryAdjdTransferredToChildrenAmt { get; }
			public Label CuryAdjdTransferredToChildrenAmtLabel { get; }
        ...
        public class c_rrdistribution_griddistribution : Grid<c_rrdistribution_griddistribution.c_grid_row, c_rrdistribution_griddistribution.c_grid_header>
        {
            ...
            public c_rrdistribution_griddistribution(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t14_RUTROTForm_gridDistribution");
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_at_tlb div[data-cmd=\'Refresh\']" +
                            "", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_at_tlb div[data-cmd=\'AdjustCol" +
                            "umns\']", "Fit to Screen", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_ab_tlb div[data-cmd=\'PageFirst" +
                            "\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_ab_tlb div[data-cmd=\'PagePrev\'" +
                            "]", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_ab_tlb div[data-cmd=\'PageNext\'" +
                            "]", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_ab_tlb div[data-cmd=\'PageLast\'" +
                            "]", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t14_RUTROTForm_gridDistribution_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public PXNumberEdit LineNbr { get; }
                ...
                public c_grid_row(c_rrdistribution_griddistribution grid) : 
                        base(grid)
                {
                    PersonalID = new PXTextEdit("_ctl00_phG_tab_t14_RUTROTForm_gridDistribution_lv0_edPersonalID", "Personal ID", grid.Locator, "PersonalID");
                    PersonalID.DataField = "PersonalID";
                    CuryAmount = new PXNumberEdit("_ctl00_phG_tab_t14_RUTROTForm_gridDistribution_lv0_edAmount", "Amount", grid.Locator, "CuryAmount");
                    CuryAmount.DataField = "CuryAmount";
                    Extra = new CheckBox("ctl00_phG_tab_t14_RUTROTForm_gridDistribution", "Extra", grid.Locator, "Extra");
                    Extra.DataField = "Extra";
                    DocType = new PXTextEdit("ctl00_phG_tab_t14_RUTROTForm_gridDistribution_ei", "DocType", grid.Locator, "DocType");
                    DocType.DataField = "DocType";
                    RefNbr = new PXTextEdit("ctl00_phG_tab_t14_RUTROTForm_gridDistribution_ei", "RefNbr", grid.Locator, "RefNbr");
                    RefNbr.DataField = "RefNbr";
                    LineNbr = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_gridDistribution_en", "Line Nbr.", grid.Locator, "LineNbr");
                    LineNbr.DataField = "LineNbr";
                }
            }
        ...
        public class c_rrdistribution_lv0 : Container
        {
            ...
            public c_rrdistribution_lv0(string locator, string name) : 
                    base(locator, name)
            {
                PersonalID = new PXTextEdit("ctl00_phG_tab_t14_RUTROTForm_gridDistribution_lv0_edPersonalID", "Personal ID", locator, null);
                PersonalIDLabel = new Label(PersonalID);
                PersonalID.DataField = "PersonalID";
                CuryAmount = new PXNumberEdit("ctl00_phG_tab_t14_RUTROTForm_gridDistribution_lv0_edAmount", "Amount", locator, null);
        ...
        public class c_sitestatusfilter_formsitesstatus : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                Mode.DataField = "Mode";
                HistoryDate = new DateSelector("ctl00_phG_PanelAddSiteStatus_formSitesStatus_gpMode_edHistoryDate", "History Date", locator, null);
                ...
                CustomerLocationID = new Selector("ctl00_phG_PanelAddSiteStatus_formSitesStatus_edCustomerLocationIDApply", "Customer Location ID", locator, null);
                CustomerLocationIDLabel = new Label(CustomerLocationID);
                CustomerLocationID.DataField = "CustomerLocationID";
        ...
        public class c_blanketorderchildrendisplaylist_ordersgrid : Grid<c_blanketorderchildrendisplaylist_ordersgrid.c_grid_row, c_blanketorderchildrendisplaylist_ordersgrid.c_grid_header>
        {
            ...
            public c_blanketorderchildrendisplaylist_ordersgrid(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_tab_t10_ordersGrid");
                DataMemberName = "BlanketOrderChildrenDisplayList";
                Buttons = new PxButtonCollection();
                FilterForm = new c_grid_filter("ctl00_phG_tab_t10_ordersGrid_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_at_tlb div[data-cmd=\'Refresh\']", "Refresh", locator, null);
                    New = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_at_tlb div[data-cmd=\'AddNew\']", "Add Row", locator, null);
                    Delete = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_at_tlb div[data-cmd=\'Delete\']", "Delete Row", locator, null);
                    Delete.ConfirmAction = () => Alert.AlertToException("The current {0} record will be deleted.");
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_at_tlb div[data-cmd=\'AdjustColumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_at_tlb div[data-cmd=\'ExportExcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_ab_tlb div[data-cmd=\'PageFirst\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_ab_tlb div[data-cmd=\'PagePrev\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_ab_tlb div[data-cmd=\'PageNext\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_ab_tlb div[data-cmd=\'PageLast\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_tab_t10_ordersGrid_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public Button InvoiceNbrEdit { get; }
                ...
                public PxButtonCollection()
                {
                    InvoiceNbrEdit = new Button("css=div[id=\'ctl00_phG_tab_t10_ordersGrid_lv0_edChildInvoiceNbr\'] div[class=\'editB" +
                            "tnCont\'] > div > div", "InvoiceNbrEdit", "ctl00_phG_tab_t10_ordersGrid");
                    InvoiceNbrEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
			...
			public Selector OrderNbr { get; }
			public DateSelector OrderDate { get; }
			public DropDown OrderStatus { get; }
			public PXNumberEdit OrderedQty { get; }
			public PXNumberEdit CuryOrderedAmt { get; }
			public DropDown ShipmentType { get; }
			public PXTextEdit ShipmentNbr { get; }
			public PXTextEdit DisplayShippingRefNoteID { get; }
			public DateSelector ShipmentDate { get; }
			public DropDown ShipmentStatus { get; }
			public PXNumberEdit ShippedQty { get; }
			public DropDown InvoiceType { get; }
			public Selector InvoiceNbr { get; }
			public DateSelector InvoiceDate { get; }
			public DropDown InvoiceStatus { get; }
			public PXTextEdit BlanketType { get; }
			public Selector BlanketNbr { get; }
			public PXTextEdit OrderType { get; }
			public PXTextEdit ShippingRefNoteID { get; }
                
                public c_grid_row(c_blanketorderchildrendisplaylist_ordersgrid grid) : 
                        base(grid)
                {
                    CustomerLocationID = new Selector("_ctl00_phG_tab_t10_ordersGrid_lv0_es", "Ship-To Location", grid.Locator, "CustomerLocationID");
                    CustomerLocationID.DataField = "CustomerLocationID";
                    OrderNbr = new Selector("_ctl00_phG_tab_t10_ordersGrid_lv0_edChildOrderNbr", "Order Nbr.", grid.Locator, "OrderNbr");
                    OrderNbr.DataField = "OrderNbr";
                    OrderDate = new DateSelector("_ctl00_phG_tab_t10_ordersGrid_lv0_ed2", "Order Date", grid.Locator, "OrderDate");
                    OrderDate.DataField = "OrderDate";
                    OrderStatus = new DropDown("_ctl00_phG_tab_t10_ordersGrid_lv0_ec", "Order Status", grid.Locator, "OrderStatus");
                    OrderStatus.DataField = "OrderStatus";
                    OrderStatus.Items.Add("N", "Open");
                    OrderStatus.Items.Add("H", "On Hold");
                    OrderStatus.Items.Add("P", "Pending Approval");
                    OrderStatus.Items.Add("V", "Rejected");
                    OrderStatus.Items.Add("E", "Pending Processing");
                    OrderStatus.Items.Add("A", "Awaiting Payment");
                    OrderStatus.Items.Add("R", "Credit Hold");
                    OrderStatus.Items.Add("C", "Completed");
                    OrderStatus.Items.Add("L", "Canceled");
                    OrderStatus.Items.Add("B", "Back Order");
                    OrderStatus.Items.Add("S", "Shipping");
                    OrderStatus.Items.Add("I", "Invoiced");
                    OrderStatus.Items.Add("D", "Expired");
                    OrderedQty = new PXNumberEdit("ctl00_phG_tab_t10_ordersGrid_en", "Ordered Qty.", grid.Locator, "OrderedQty");
                    OrderedQty.DataField = "OrderedQty";
                    CuryOrderedAmt = new PXNumberEdit("ctl00_phG_tab_t10_ordersGrid_en", "Ordered Amount", grid.Locator, "CuryOrderedAmt");
                    CuryOrderedAmt.DataField = "CuryOrderedAmt";
                    ShipmentType = new DropDown("_ctl00_phG_tab_t10_ordersGrid_lv0_ec", "Shipment Type", grid.Locator, "ShipmentType");
                    ShipmentType.DataField = "ShipmentType";
                    ShipmentType.Items.Add("I", "Shipment");
                    ShipmentType.Items.Add("H", "Drop-Shipment");
                    ShipmentType.Items.Add("T", "Transfer");
                    ShipmentType.Items.Add("N", "Invoice");
                    ShipmentNbr = new PXTextEdit("ctl00_phG_tab_t10_ordersGrid_ei", "Shipment Nbr.", grid.Locator, "ShipmentNbr");
                    ShipmentNbr.DataField = "ShipmentNbr";
                    DisplayShippingRefNoteID = new PXTextEdit("ctl00_phG_tab_t10_ordersGrid_ei", "Document Nbr.", grid.Locator, "DisplayShippingRefNoteID");
                    DisplayShippingRefNoteID.DataField = "DisplayShippingRefNoteID";
                    ShipmentDate = new DateSelector("_ctl00_phG_tab_t10_ordersGrid_lv0_ed9", "Shipment Date", grid.Locator, "ShipmentDate");
                    ShipmentDate.DataField = "ShipmentDate";
                    ShipmentStatus = new DropDown("_ctl00_phG_tab_t10_ordersGrid_lv0_ec", "Shipment Status", grid.Locator, "ShipmentStatus");
                    ShipmentStatus.DataField = "ShipmentStatus";
                    ShipmentStatus.Items.Add("N", "Open");
                    ShipmentStatus.Items.Add("H", "On Hold");
                    ShipmentStatus.Items.Add("C", "Completed");
                    ShipmentStatus.Items.Add("L", "Canceled");
                    ShipmentStatus.Items.Add("F", "Confirmed");
                    ShipmentStatus.Items.Add("I", "Invoiced");
                    ShipmentStatus.Items.Add("Y", "Partially Invoiced");
                    ShipmentStatus.Items.Add("R", "Receipted");
                    ShipmentStatus.Items.Add("A", "Auto-Generated");
                    ShippedQty = new PXNumberEdit("ctl00_phG_tab_t10_ordersGrid_en", "Shipped Qty.", grid.Locator, "ShippedQty");
                    ShippedQty.DataField = "ShippedQty";
                    InvoiceType = new DropDown("_ctl00_phG_tab_t10_ordersGrid_lv0_ec", "Invoice Type", grid.Locator, "InvoiceType");
                    InvoiceType.DataField = "InvoiceType";
                    InvoiceType.Items.Add("INV", "Invoice");
                    InvoiceType.Items.Add("DRM", "Debit Memo");
                    InvoiceType.Items.Add("CRM", "Credit Memo");
                    ...
                    InvoiceDate.DataField = "InvoiceDate";
                    InvoiceStatus = new DropDown("_ctl00_phG_tab_t10_ordersGrid_lv0_ec", "Invoice Status", grid.Locator, "InvoiceStatus");
                    InvoiceStatus.DataField = "InvoiceStatus";
                    InvoiceStatus.Items.Add("R", "Credit Hold");
                    InvoiceStatus.Items.Add("W", "Pending Processing");
                    InvoiceStatus.Items.Add("H", "On Hold");
                    InvoiceStatus.Items.Add("B", "Balanced");
                    InvoiceStatus.Items.Add("V", "Voided");
                    InvoiceStatus.Items.Add("S", "Scheduled");
                    InvoiceStatus.Items.Add("N", "Open");
                    InvoiceStatus.Items.Add("C", "Closed");
                    InvoiceStatus.Items.Add("P", "Pending Print");
                    InvoiceStatus.Items.Add("E", "Pending Email");
                    InvoiceStatus.Items.Add("Z", "Reserved");
                    ...
                    BlanketNbr.DataField = "BlanketNbr";
                    OrderType = new PXTextEdit("_ctl00_phG_tab_t10_ordersGrid_lv0_edChildOrderType", "Order Type", grid.Locator, "OrderType");
                    OrderType.DataField = "OrderType";
                    ShippingRefNoteID = new PXTextEdit("ctl00_phG_tab_t10_ordersGrid", "ShippingRefNoteID", grid.Locator, "ShippingRefNoteID");
                    ShippingRefNoteID.DataField = "ShippingRefNoteID";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
				...
				public DropDownColumnFilter OrderStatus { get; }
				public PXNumberEditColumnFilter OrderedQty { get; }
				public PXNumberEditColumnFilter CuryOrderedAmt { get; }
				public DropDownColumnFilter ShipmentType { get; }
				public PXTextEditColumnFilter ShipmentNbr { get; }
				public PXTextEditColumnFilter DisplayShippingRefNoteID { get; }
				public DateSelectorColumnFilter ShipmentDate { get; }
				public DropDownColumnFilter ShipmentStatus { get; }
				public PXNumberEditColumnFilter ShippedQty { get; }
				public DropDownColumnFilter InvoiceType { get; }
				public SelectorColumnFilter InvoiceNbr { get; }
				public DateSelectorColumnFilter InvoiceDate { get; }
				public DropDownColumnFilter InvoiceStatus { get; }
				public PXTextEditColumnFilter BlanketType { get; }
				public SelectorColumnFilter BlanketNbr { get; }
				public PXTextEditColumnFilter OrderType { get; }
				public PXTextEditColumnFilter ShippingRefNoteID { get; }
                
                public c_grid_header(c_blanketorderchildrendisplaylist_ordersgrid grid) : 
                        base(grid)
                {
                    CustomerLocationID = new SelectorColumnFilter(grid.Row.CustomerLocationID);
                    OrderNbr = new SelectorColumnFilter(grid.Row.OrderNbr);
                    OrderDate = new DateSelectorColumnFilter(grid.Row.OrderDate);
                    OrderStatus = new DropDownColumnFilter(grid.Row.OrderStatus);
                    OrderedQty = new PXNumberEditColumnFilter(grid.Row.OrderedQty);
                    CuryOrderedAmt = new PXNumberEditColumnFilter(grid.Row.CuryOrderedAmt);
                    ShipmentType = new DropDownColumnFilter(grid.Row.ShipmentType);
                    ShipmentNbr = new PXTextEditColumnFilter(grid.Row.ShipmentNbr);
                    DisplayShippingRefNoteID = new PXTextEditColumnFilter(grid.Row.DisplayShippingRefNoteID);
                    ShipmentDate = new DateSelectorColumnFilter(grid.Row.ShipmentDate);
                    ShipmentStatus = new DropDownColumnFilter(grid.Row.ShipmentStatus);
                    ShippedQty = new PXNumberEditColumnFilter(grid.Row.ShippedQty);
                    InvoiceType = new DropDownColumnFilter(grid.Row.InvoiceType);
                    InvoiceNbr = new SelectorColumnFilter(grid.Row.InvoiceNbr);
                    InvoiceDate = new DateSelectorColumnFilter(grid.Row.InvoiceDate);
                    InvoiceStatus = new DropDownColumnFilter(grid.Row.InvoiceStatus);
                    BlanketType = new PXTextEditColumnFilter(grid.Row.BlanketType);
                    BlanketNbr = new SelectorColumnFilter(grid.Row.BlanketNbr);
                    OrderType = new PXTextEditColumnFilter(grid.Row.OrderType);
                    ShippingRefNoteID = new PXTextEditColumnFilter(grid.Row.ShippingRefNoteID);
                }
        ...
        public class c_blanketorderchildrendisplaylist_lv0 : Container
        {
            ...
            public c_blanketorderchildrendisplaylist_lv0(string locator, string name) : 
                    base(locator, name)
            {
                OrderType = new PXTextEdit("ctl00_phG_tab_t10_ordersGrid_lv0_edChildOrderType", "Order Type", locator, null);
                OrderTypeLabel = new Label(OrderType);
                OrderType.DataField = "OrderType";
                OrderNbr = new Selector("ctl00_phG_tab_t10_ordersGrid_lv0_edChildOrderNbr", "Order Nbr.", locator, null);
                OrderNbrLabel = new Label(OrderNbr);
                OrderNbr.DataField = "OrderNbr";
                InvoiceNbr = new Selector("ctl00_phG_tab_t10_ordersGrid_lv0_edChildInvoiceNbr", "Invoice Nbr.", locator, null);
                InvoiceNbrLabel = new Label(InvoiceNbr);
                InvoiceNbr.DataField = "InvoiceNbr";
                Es = new Selector("ctl00_phG_tab_t10_ordersGrid_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ed = new DateSelector("ctl00_phG_tab_t10_ordersGrid_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                Ec = new DropDown("ctl00_phG_tab_t10_ordersGrid_lv0_ec", "Ec", locator, null);
                DataMemberName = "BlanketOrderChildrenDisplayList";
                Buttons = new PxButtonCollection();
            }
			...
			public Button InvoiceNbrEdit { get; }
                ...
                {
                    InvoiceNbrEdit = new Button("css=div[id=\'ctl00_phG_tab_t10_ordersGrid_lv0_edChildInvoiceNbr\'] div[class=\'editB" +
                            "tnCont\'] > div > div", "InvoiceNbrEdit", "ctl00_phG_tab_t10_ordersGrid_lv0");
                    InvoiceNbrEdit.WaitAction = Wait.WaitForNewWindowToOpen;
                }
            }
        }
        
        public class c_blanketsplits_gridblanketsplits : Grid<c_blanketsplits_gridblanketsplits.c_grid_row, c_blanketsplits_gridblanketsplits.c_grid_header>
        {
            ...
            public c_blanketsplits_gridblanketsplits(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits");
                DataMemberName = "BlanketSplits";
                Buttons = new PxButtonCollection();
                FilterForm = new c_grid_filter("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_fe_gf", "FilterForm");
            }
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    Refresh = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_at_tlb div[data-cmd=\'Refresh" +
                            "\']", "Refresh", locator, null);
                    Adjust = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_at_tlb div[data-cmd=\'AdjustC" +
                            "olumns\']", "Fit to Screen", locator, null);
                    Export = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_at_tlb div[data-cmd=\'ExportE" +
                            "xcel\']", "Export to Excel", locator, null);
                    Hi = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_at_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                    PageFirst = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ab_tlb div[data-cmd=\'PageFir" +
                            "st\']", "Go to First Page (Ctrl+PgUp)", locator, null);
                    PagePrev = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ab_tlb div[data-cmd=\'PagePre" +
                            "v\']", "Go to Previous Page (PgUp)", locator, null);
                    PageNext = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ab_tlb div[data-cmd=\'PageNex" +
                            "t\']", "Go to Next Page (PgDn)", locator, null);
                    PageLast = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ab_tlb div[data-cmd=\'PageLas" +
                            "t\']", "Go to Last Page (Ctrl+PgDn)", locator, null);
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
			...
			public Button Cancel { get; }
                ...
                public PxButtonCollection()
                {
                    Add = new Button("ctl00_phG_PanelAddBlanketLine_PXButton11", "Add", "ctl00_phG_PanelAddBlanketLine_gridBlanketSplits");
                    AddClose = new Button("ctl00_phG_PanelAddBlanketLine_PXButton12", "Add & Close", "ctl00_phG_PanelAddBlanketLine_gridBlanketSplits");
                    Cancel = new Button("ctl00_phG_PanelAddBlanketLine_PXButton13", "Cancel", "ctl00_phG_PanelAddBlanketLine_gridBlanketSplits");
                }
            }
			...
			public PXNumberEdit SplitLineNbr { get; }
                ...
                public c_grid_row(c_blanketsplits_gridblanketsplits grid) : 
                        base(grid)
                {
                    Selected = new CheckBox("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ef", "Selected", grid.Locator, "Selected");
                    Selected.DataField = "Selected";
                    OrderType = new PXTextEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ei", "Order Type", grid.Locator, "OrderType");
                    OrderType.DataField = "OrderType";
                    OrderNbr = new PXTextEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ei", "Order Nbr.", grid.Locator, "OrderNbr");
                    OrderNbr.DataField = "OrderNbr";
                    SchedOrderDate = new DateSelector("_ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_ed3", "Sched. Order Date", grid.Locator, "SchedOrderDate");
                    SchedOrderDate.DataField = "SchedOrderDate";
                    InventoryID = new Selector("_ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_es", "Inventory ID", grid.Locator, "InventoryID");
                    InventoryID.DataField = "InventoryID";
                    SubItemID = new Selector("_ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_es", "Subitem", grid.Locator, "SubItemID");
                    SubItemID.DataField = "SubItemID";
                    TranDesc = new PXTextEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ei", "Description", grid.Locator, "TranDesc");
                    TranDesc.DataField = "TranDesc";
                    SiteID = new Selector("_ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_es", "Warehouse", grid.Locator, "SiteID");
                    SiteID.DataField = "SiteID";
                    CustomerOrderNbr = new PXTextEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ei", "Customer Order Nbr.", grid.Locator, "CustomerOrderNbr");
                    CustomerOrderNbr.DataField = "CustomerOrderNbr";
                    UOM = new Selector("_ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_es", "UOM", grid.Locator, "UOM");
                    UOM.DataField = "UOM";
                    BlanketOpenQty = new PXNumberEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_en", "Blanket Open Qty.", grid.Locator, "BlanketOpenQty");
                    BlanketOpenQty.DataField = "BlanketOpenQty";
                    CustomerLocationID = new Selector("_ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_es", "Ship-To Location", grid.Locator, "CustomerLocationID");
                    CustomerLocationID.DataField = "CustomerLocationID";
                    TaxZoneID = new PXTextEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_ei", "Tax Zone", grid.Locator, "TaxZoneID");
                    TaxZoneID.DataField = "TaxZoneID";
                    LineNbr = new PXNumberEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_en", "LineNbr", grid.Locator, "LineNbr");
                    LineNbr.DataField = "LineNbr";
                    SplitLineNbr = new PXNumberEdit("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_en", "SplitLineNbr", grid.Locator, "SplitLineNbr");
            ...
            public class c_grid_header : GridHeader
            {
                ...
                public c_grid_header(c_blanketsplits_gridblanketsplits grid) : 
                        base(grid)
                {
                    Selected = new CheckBoxColumnFilter(grid.Row.Selected);
                    OrderType = new PXTextEditColumnFilter(grid.Row.OrderType);
        ...
        public class c_blanketsplits_lv0 : Container
        {
            ...
            public c_blanketsplits_lv0(string locator, string name) : 
                    base(locator, name)
            {
                Es = new Selector("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ed = new DateSelector("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                Em = new Selector("ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0_em", "Em", locator, null);
                EmLabel = new Label(Em);
                DataMemberName = "BlanketSplits";
                Buttons = new PxButtonCollection();
            }
			...
			public Button Cancel { get; }
                ...
                public PxButtonCollection()
                {
                    Add = new Button("ctl00_phG_PanelAddBlanketLine_PXButton11", "Add", "ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0");
                    AddClose = new Button("ctl00_phG_PanelAddBlanketLine_PXButton12", "Add & Close", "ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0");
                    Cancel = new Button("ctl00_phG_PanelAddBlanketLine_PXButton13", "Cancel", "ctl00_phG_PanelAddBlanketLine_gridBlanketSplits_lv0");
                }
            }
        }
        
        public class c_blankettaxzoneoverridefilter_formoverridetaxzone : Container
        {
			...
			public Selector TaxZoneID { get; }
			public Label TaxZoneIDLabel { get; }
			public Label LblRecalcTaxes_ { get; }
            
            public c_blankettaxzoneoverridefilter_formoverridetaxzone(string locator, string name) : 
                    base(locator, name)
            {
                TaxZoneID = new Selector("ctl00_phG_PanelOverrideTaxZone_formOverrideTaxZone_edTaxZoneID", "Customer Tax Zone", locator, null);
                TaxZoneIDLabel = new Label(TaxZoneID);
                TaxZoneID.DataField = "TaxZoneID";
                LblRecalcTaxes_ = new Label("ctl00_phG_PanelOverrideTaxZone_formOverrideTaxZone_lblRecalcTaxes", "Taxes will be recalculated based on the overridden tax zone. Do you want to conti" +
                        "nue?", locator, null);
                DataMemberName = "BlanketTaxZoneOverrideFilter";
                Buttons = new PxButtonCollection();
            }
			...
			public Button No { get; }
                ...
                public PxButtonCollection()
                {
                    Yes = new Button("ctl00_phG_PanelOverrideTaxZone_btnOverrideOK", "Yes", "ctl00_phG_PanelOverrideTaxZone_formOverrideTaxZone");
                    No = new Button("ctl00_phG_PanelOverrideTaxZone_btnOverrideCancel", "No", "ctl00_phG_PanelOverrideTaxZone_formOverrideTaxZone");
                }
            }
        }
        ...
        public class c_splits_grid2 : Grid<c_splits_grid2.c_grid_row, c_splits_grid2.c_grid_header>
        {
			...
			public PXNumberEdit LineNbr { get; }
                        ...
                        base(grid)
                {
                    ...
                    SubItemID.DataField = "SubItemID";
                    SchedOrderDate = new DateSelector("_ctl00_phG_PanelLS_grid2_lv0_ed4", "Sched. Order Date", grid.Locator, "SchedOrderDate");
                    SchedOrderDate.DataField = "SchedOrderDate";
                    SchedShipDate = new DateSelector("_ctl00_phG_PanelLS_grid2_lv0_ed5", "Sched. Shipment Date", grid.Locator, "SchedShipDate");
                    SchedShipDate.DataField = "SchedShipDate";
                    CustomerOrderNbr = new PXTextEdit("ctl00_phG_PanelLS_grid2_ei", "Customer Order Nbr.", grid.Locator, "CustomerOrderNbr");
                    CustomerOrderNbr.DataField = "CustomerOrderNbr";
                    ShipDate = new DateSelector("_ctl00_phG_PanelLS_grid2_lv0_ed7", "Ship On", grid.Locator, "ShipDate");
                    ShipDate.DataField = "ShipDate";
                    ...
                    Qty.DataField = "Qty";
                    QtyOnOrders = new PXNumberEdit("ctl00_phG_PanelLS_grid2_en", "Qty. On Orders", grid.Locator, "QtyOnOrders");
                    QtyOnOrders.DataField = "QtyOnOrders";
                    ...
                    BlanketOpenQty = new PXNumberEdit("ctl00_phG_PanelLS_grid2_en", "Blanket Open Qty.", grid.Locator, "BlanketOpenQty");
                    BlanketOpenQty.DataField = "BlanketOpenQty";
                    ...
                    POCreate.DataField = "POCreate";
                    POCreateDate = new DateSelector("_ctl00_phG_PanelLS_grid2_lv0_ed21", "PO Creation Date", grid.Locator, "POCreateDate");
                    POCreateDate.DataField = "POCreateDate";
        ...
        public class c_orderestimaterecords_gridestimates : Grid<c_orderestimaterecords_gridestimates.c_grid_row, c_orderestimaterecords_gridestimates.c_grid_header>
        {
			...
			public Selector AMEstimateItem__BranchID { get; }
			...
			public Selector AMEstimateItem__EstimateClassID { get; }
                ...
                public c_grid_row(c_orderestimaterecords_gridestimates grid) : 
                        base(grid)
                {
                    AMEstimateItem__BranchID = new Selector("_ctl00_phG_tab_t1_gridEstimates_lv0_edEstBranch", "AM Estimate Item __ Branch ID", grid.Locator, "AMEstimateItem__BranchID");
                    AMEstimateItem__BranchID.DataField = "AMEstimateItem__BranchID";
            ...
            public class c_grid_header : GridHeader
            {
				...
				public SelectorColumnFilter AMEstimateItem__BranchID { get; }
                ...
                public c_grid_header(c_orderestimaterecords_gridestimates grid) : 
                        base(grid)
                {
                    AMEstimateItem__BranchID = new SelectorColumnFilter(grid.Row.AMEstimateItem__BranchID);
        ...
        public class c_orderestimaterecords_lv0 : Container
        {
			...
			public Selector AMEstimateItem__BranchID { get; }
			public Label AMEstimateItem__BranchIDLabel { get; }
			public Selector AMEstimateItem__InventoryCD { get; }
            ...
            public c_orderestimaterecords_lv0(string locator, string name) : 
                    base(locator, name)
            {
                AMEstimateItem__BranchID = new Selector("ctl00_phG_tab_t1_gridEstimates_lv0_edEstBranch", "AM Estimate Item __ Branch ID", locator, null);
                AMEstimateItem__BranchIDLabel = new Label(AMEstimateItem__BranchID);
                AMEstimateItem__BranchID.DataField = "AMEstimateItem__BranchID";
        ...
        public class c_soorderlinesplittingextension_lotseroptions_optform : Container
        {
            ...
            public c_soorderlinesplittingextension_lotseroptions_optform(string locator, string name) : 
                    base(locator, name)
            {
                ...
                DataMemberName = "SOOrderLineSplittingExtension_LotSerOptions";
                Buttons = new PxButtonCollection();
            }
